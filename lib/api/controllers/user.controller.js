...
function create(req, res, next) {
  ...
  req.body.address = sanitizer.sanitize(req.body.address);  
  req.body.city = sanitizer.sanitize(req.body.city);  
  req.body.province = sanitizer.sanitize(req.body.province);  
  req.body.postalCode = sanitizer.sanitize(req.body.postalCode);    
  req.body.country = sanitizer.sanitize(req.body.country);  
