...
function create(req, res, next) {
  ...
  req.body.category = sanitizer.sanitize(req.body.category); 
  req.body.gender = sanitizer.sanitize(req.body.gender); 
  req.body.price = sanitizer.sanitize(req.body.price); 
  req.body.sizes = sanitizer.sanitize(req.body.sizes); 
  req.body.colors = sanitizer.sanitize(req.body.colors); 
  req.body.imageUrl = sanitizer.sanitize(req.body.imageUrl); 
...
function update(req, res, next) {
  ...
  req.body.colors = sanitizer.sanitize(req.body.colors); 
  req.body.imageUrl = sanitizer.sanitize(req.body.imageUrl); 
  req.product = sanitizer.sanitize(req.product); 
